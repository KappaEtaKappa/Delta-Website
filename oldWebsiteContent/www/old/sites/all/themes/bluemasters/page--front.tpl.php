...
<div id="header-top">
    <div id="header-top-inside" class="clearfix">
        ...
        <div id="header-top-inside-left-feed">
            <div id="topSocial">
            <ul>
                <li><a class="twitter" href="http://twitter.com/khkDelta" title="Follow Us on Twitter!"></a></li>
                <li><a class="facebook" href="http://www.facebook.com/khk.delta" title="Join Us on Facebook!"></a></li>
        ...
        <div class="main_view">
            <div class="window">
                <div class="image_reel">
                    <a href="<?php print url('node/3'); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'bluemasters') . '/images/slide-image-1.jpg'; ?>"></a>
                ...
                <div class="descriptions">
                    <div class="desc" style="display: none;">Hanging New Sign</div>
                    <div class="desc" style="display: none;">KHK Formal 2011</div>
                    <div class="desc" style="display: none;">KHK Members Enjoying Dinner</div>
                </div>
            </div>
