...
Depends: SuperCPT
Description: Creates a "Member" Custom Post Type for all KHK alumni/members/pledges.
...
function KHK_Directory() {
    ...
    $tax_statuses = new Super_Custom_Taxonomy( 'tax-statuses', 'Status', 'Statuses', 'statuses');
    connect_types_and_taxes( $people, array($tax_statuses ) );
